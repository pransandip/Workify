    ...
    <div className="main-app-grid admin-main-content-dv">
      ...
      <div className='main-mid-container'>
        <div className="edit-pg-holder">
          <Grid container spacing={2} className={'max-width700'}>
            <Grid item xs={12} display={'flex'} >
                <Heading3Bold text={'Contact us Enquiries '} color={Colors.black} margin={'16px 0 30px 0'}  />
            </Grid>
            ...
            <Grid item xs={12} sm={12} md={12} style={{paddingTop: '0px'}}>
                <div className="grid-item">
                  <InputLabel text={'message'} color={Colors.nightGray}  padding={'0 0 8px 0'} className={'inputlabel'} />
