...
function ManageCertificate(props) {
  ...
  const rows = [
    createData('Lorem Ipsumm', '', '',),
    createData('Lorem Ipsummm',  '', '',),
    createData('Lorem Ipsummmm',  '', '',),
    createData('Lorem Ipsummmmm', '', '',),
    createData('Lorem Ipsummmmmm',  '', '',),
  ];
  return (
        ...
        <div className="staff-holder">
          <Grid container spacing={2}>
            <Grid item xs={12} display={'flex'} alignItems={'center'} textAlign={'center'} justifyContent={'space-between'} margin={'0px 0px 24px 0px'}>
                <Heading3Bold text={'Manage Certificate '}  color={Colors.black} className={'heading3bold'} />
                <PrimaryButton className='primarybutton' width={'155px'} onClick={addEditInductryOpen} text={'Add Certificate '} />
            </Grid>
            <Grid item xs={12}>
          ...
          >
            ...
            <DialogContent>
              <div className="grid-item">
                <InputLabel text={'Certificate Name'} color={Colors.nightGray} padding={'0 0 4px 0'} className={'inputlabel'} />
