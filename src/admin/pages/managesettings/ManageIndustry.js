        ...
        <div className="staff-holder">
          <Grid container spacing={2}>
            <Grid item xs={12} display={'flex'} alignItems={'center'} textAlign={'center'} justifyContent={'space-between'} margin={'0px 0px 24px 0px'}>
                <Heading3Bold text={'Manage Industry'}  color={Colors.black} className={'heading3bold'} />
                <PrimaryButton className='primarybutton' width={'155px'} onClick={addEditInductryOpen} text={'Add Industry'} />
            </Grid>
            <Grid item xs={12}>
          ...
          >
            ...
            <DialogContent>
              <div className="grid-item">
                <InputLabel text={'Industry Name'} color={Colors.nightGray} padding={'0 0 4px 0'} className={'inputlabel'} />
