...
function ManageProvince(props) {
  
  const [addEditProvinceopen, setOpen] = React.useState(false);
  const [deleteProvinceopen, deleteOpen] = React.useState(false);

  const addEditClickOpen = () => { setOpen(true); };
  ...
  function createData( name, ActiveInactive, Action, ) {
    return { name, ActiveInactive, Action };
  }
  const rows = [
    createData('Ricardo Seah1', '', '',),
    createData('Ricardo Seah2', '', '',),
    createData('Ricardo Seah3', '', '',),
    createData('Ricardo Seah4', '', '',),
    createData('Ricardo Seah5', '', '',),
  ];
  return (
        ...
        <div className="staff-holder">
          <Grid container spacing={2}>
            <Grid item xs={12} display={'flex'} alignItems={'center'} textAlign={'center'} justifyContent={'space-between'} margin={'0px 0px 24px 0px'}>
                <Heading3Bold text={'Manage Province'}  color={Colors.black} className={'heading3bold'} />
                <PrimaryButton className='primarybutton' width={'155px'} onClick={addEditClickOpen} text={'Add Province '} />
            </Grid>
            <Grid item xs={12}>
                    ...
                    {rows.map((row) => (
                      ...
                      >
                        ...
                        <TableCell align="center">
                          <Link to="#" className={'edit-color'} onClick={addEditClickOpen}>{'Edit'}</Link>
          ...
          >
            ...
            <DialogContent>
              <div className="grid-item">
                <InputLabel text={'Name'} color={Colors.nightGray} padding={'0 0 4px 0'} className={'inputlabel'} />
