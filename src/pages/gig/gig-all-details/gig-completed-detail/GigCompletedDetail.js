...
function GigCompletedDetail(props) {
  ...
  // console.log('gig_details', gig_details);
        ...
        <div className="gigcompleted-main-holder">
          ...
          <Box sx={{ width: "100%" }}>
            ...
            <TabPanel className={"tabpanels"} value={value} index={1}>
              <GigDetailCompletedCostBreakdown gig_details={gig_details} />
            </TabPanel>
            <TabPanel className={"tabpanels"} value={value} index={2}>
              <GigDetailCompletedInvoice gig_details={gig_details} />
            </TabPanel>
          </Box>
        </div>
      </div>
...
export default GigCompletedDetail;
