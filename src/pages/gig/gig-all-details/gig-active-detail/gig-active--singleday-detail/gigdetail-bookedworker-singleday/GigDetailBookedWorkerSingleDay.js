...
import EditIcon from '../../../../../../image-assets/structure/edit-icon.svg';
       ...
       <Accordion expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
        ...
        <AccordionDetails>
          <Box className={'collapseContentTop'}>
            <Body className={'body'} color={Colors.midGray} text={'Monday, April 4th, 2022'} />
            <Box display={'flex'}>
      ...
      <Accordion expanded={expanded === 'panel4 '} onChange={handleChange('panel4 ')}>
        ...
        <Box className={'collapseContentTop'}>
          ...
          <Box display={'flex'} alignItems={'center'}>
            ...
            <img src={EditIcon} className={open ? 'editIcon hide': 'editIcon'}  onClick={handleClick} alt="" />
          </Box>
        </Box>
          <Collapse in={open} timeout="auto" unmountOnExit>
            <CheckInCollapse />
